...
public class Faker {
    ...
    public static String nombrePuerto() {
        return deLista(ciudades) + " Port";
    }

    public static String ubicacionPuerto() {
        return deLista(ciudades) + ", " + deLista(ciudades);
    }

    public static int capacidadPuerto() {
        return entero(50, 200);
    }

    public static double tarifaBasePuerto() {
        return precio(50.0, 200.0);
    }

    public static String nombreAmarre() {
        return "Amarre " + entero(1, 100);
    }

    public static int numeroAmarre() {
        return entero(1, 100);
    }
    ...
    public static double precioDia() {
        return precio(20.0, 150.0);
    }
    ...
    public static double pesoEmbarcacion() {
        // Peso típico: 500kg a 50 toneladas
        return precio(0.5, 50.0);
    }

    public static double longitudEmbarcacion() {
